...
systemctl start otbr_fwcfg
sleep 5
otbr-agent-iwxxx-spi -I wpan0 -B mlan0 'spinel+spi:///dev/spidev2.0?gpio-reset-device=/dev/gpiochip4&gpio-int-device=/dev/gpiochip2&gpio-int-line=7&gpio-reset-line=00&spi-mode=0&spi-speed=1000000&spi-reset-delay=0' &
...
ot-ctl dataset meshlocalprefix fde2:498c:88c6:1b27:
